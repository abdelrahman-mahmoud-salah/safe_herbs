...
export function initFarms() {
    ...
    const FARMS = [
        { name: 'Fayoum', x: 0.42, y: 0.48, main: true, col: '#c8a052' },
        { name: 'Beni Suef', x: 0.46, y: 0.56, main: true, col: '#5a8040' },
        { name: 'Al Minia', x: 0.48, y: 0.63, main: false, col: '#6b8c6b' },
        { name: 'Assuit', x: 0.5, y: 0.7, main: false, col: '#7a5c3a' },
        { name: 'Luxor', x: 0.54, y: 0.8, main: false, col: '#7a5c3a', },
        { name: 'Al Wahat', x: 0.28, y: 0.62, main: false, col: '#5a8040' }
    ...
    function draw() {
        ...
        /* Scale font sizes relative to canvas for responsive text */
        const baseFontSize = Math.max(9, Math.min(12, W * 0.028));
        ...
        FARMS.forEach((f, i) => {
            ...
            ctx.font = `${f.main ? '600' : '400'} ${f.main ? baseFontSize + 1 : baseFontSize}px Inter, sans-serif`;
    ...
    /* Pause when farms section is off-screen */
